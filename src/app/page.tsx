  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-10 w-full border-b border-border bg-background/95 backdrop-blur-sm">
        <div className="container mx-auto flex h-16 items-center justify-end p-4 relative">
      ...
      <main className="flex-grow container mx-auto p-4 sm:p-6 md:p-8">
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 items-start mt-8">
            <div className="space-y-4 lg:col-span-3">
                <h3 className="text-2xl font-semibold text-center">Consignment View</h3>
                <BarcodeColumnGenerator />
            </div>
            <div className="space-y-4 lg:col-span-7">
                <h3 className="text-2xl font-semibold text-center">Container View</h3>
